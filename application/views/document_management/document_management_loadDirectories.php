...
<button class='btn btn-primary' title='Create Folder' onclick='addFolder();'><span class='glyphicon glyphicon-folder-open'></span > <span style='margin-left:1px;' class='glyphicon glyphicon-plus'></span>Create Folder</button>	
</div>	
