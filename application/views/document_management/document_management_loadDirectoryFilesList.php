...
<td><button class='btn' title='Edit' style='width:100%; background:rgba(0,0,0,0);' onclick='editFile($fdid)'><span class='glyphicon glyphicon-edit'></span></button></td>
<td><button class='btn' title='Edit' style='width:100%; background:rgba(0,0,0,0);' onclick='MoveFile($fdid)'><span class='glyphicon glyphicon-transfer'></span></button></td>
...
<td><button class='btn' title='Delete' style='width:100%; background:rgba(0,0,0,0);' onclick='deleteFile($fdid);'><span class='glyphicon glyphicon-remove'></span></button></td>
</tr>
";
}
